...
import 'package:ieee_student/Pages/navigation.dart';
import 'package:ieee_student/progress_button/progress_button.dart';
import 'package:ieee_student/progress_button/reveal_progress_button_painter.dart';
    ...
    _animation = Tween(begin: 0.0, end: 1.0).animate(_controller)
      ...
      ..addStatusListener((AnimationStatus state) {
        if (state == AnimationStatus.completed) {
          Navigation.navigateTo(context, 'Student-Login',
